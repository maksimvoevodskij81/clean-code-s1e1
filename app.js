...
var taskInput=document.getElementById("add__input-id");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById("todo__incomplete-tasks");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("completed-tasks__id");//completed-tasks__id
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    const classesForInputText=['main__task','main__input_text']
    editInput.classList.add(...classesForInputText)    

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    const classesForEditBtn=['main__edit','main__button'];
    editButton.classList.add(...classesForEditBtn)         
    const classesForDeleteBtn=['main__delete','main__button'];
...
var taskCompleted=function(){
    ...
    //Append the task list item to the #completed-tasks__id
    var listItem=this.parentNode;
